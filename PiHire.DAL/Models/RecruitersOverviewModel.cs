...
namespace PiHire.DAL.Models
{
    ...
    public class RecruitersVM
    {
        public List<RecruitersOverviewModel> RecruitersOverviewModel { get; set; }
        public DateTime FromDate { get; set; }
        public DateTime ToDate { get; set; }
    }
    public class RecruitersOverviewModel
    {
    ...
    public class RecruiterOpeningOverviewModel
    {
        public int JobId { get; set; }
        public string JobTitle { get; set; }
        public string JobStatus { get; set; }
    ...
    public class CandidatesSourceVM
    {
        public List<CandidatesSourceOverviewModel> CandidatesSourceOverviewModel { get; set; }
        public DateTime FromDate { get; set; }
        public DateTime ToDate { get; set; }
    }
    public class CandidatesSourceOverviewModel
    {
        public string Name { get; set; }
        public int UserId { get; set; }
        public string Location { get; set; }
    ...
    public class SourcedCandidatesVM
    {
        public List<SourcedCandidatesModel> SourcedCandidatesModel { get; set; }
        public DateTime FromDate { get; set; }
        public DateTime ToDate { get; set; }
    }

    public class SourcedCandidatesModel
    {
        public int CandProfId { get; set; }
        public string CandName { get; set; }
    ...
    public class WebSourceRecruitersVM
    {
        public List<WebSourceRecruitersOverviewModel> RecruitersOverviewModel { get; set; }
        public DateTime FromDate { get; set; }
        public DateTime ToDate { get; set; }
    }

    public class WebSourceRecruitersOverviewModel
    {
        public int UserId { get; set; }
        public string Name { get; set; }
        public string Location { get; set; }
        ...
        public string MobileNumber { get; set; }
        public string EmailId { get; set; }
        public int? ScdCVCount  { get; set; }
        public int? SvdCVCount  { get; set; }
        public int? FinalCVCount { get; set; }
        public int? PiRejectCount { get; set; }
        public int? ClntSubmisionCount { get; set; }
        public int? InterviewsCount { get; set; }
